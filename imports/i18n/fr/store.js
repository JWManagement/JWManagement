const store = {
  title: 'Tableau de bord du stock des publications',
  short: 'Raccourci',
  language: 'Langue',
  languages: 'Langues',
  total: 'Total',
  ...
  hideAll: 'Masque toutes les publications non-ajoutées',
  reset: 'Remets à zéro le stock des publications',
  noPublication: 'Tu n\'as pas ajouté de publications pour le moment.<br>Pour ajouter une publication, utilise le bouton "Afficher toutes les publications" qui sont disponibles.<br>Ensuite, sélectionne toutes les publications que tu soustraits du stock des publications.<br>Clic sur la publication pour indiquer les langues dans lesquelles elle est stockée.',
  startAddLanguage: 'Ajoute une langue',
  cancelAddLanguage: 'Annuler',
  close: 'Fermer',
  addLanguage: 'Ajouter',
  removeLanguage: 'Ôter cette langue',
  setup: {
