const mail = {
  ...
  teamCancellation: {
    ...
    hello: 'Witaj',
    text: 'Niestety chcieliśmy poinformować Cię, że twoja zmiana <b>{{date}}</b> o <b>{{time}}</b> godzinie został <u>anulowany</u>.',
  ...
  declined: {
    ...
    hello: 'Witaj',
    text1: 'Niestety Twoje zgłoszenie dotycząca następujących zmian nie zostało zaakceptowane:',
